...
def choose_quadrants():
    ...
    print(f'Q1: {(Goals["Q1"]/np.array((img.shape[1],img.shape[0])))*np.array((1920,1080)) }')
    print(f'Q2: {(Goals["Q2"]/np.array((img.shape[1],img.shape[0])))*np.array((1920,1080))}')
    print(f'Q3: {(Goals["Q3"]/np.array((img.shape[1],img.shape[0])))*np.array((1920,1080)) }')
    print(f'Q4: {(Goals["Q4"]/np.array((img.shape[1],img.shape[0])))*np.array((1920,1080))}')
